...
const keywordList = [
    "Python", "C", "Java", "C++", "JavaScript", "React", "Node.js", "Bash", "Scripting", "Git",
    "Docker", "Kubernetes", "Cloud Computing", "SOPS", "HashiCorp Vault", "Microservices", "Containerization", "Continuous Integration", "Continuous Delivery", "GitHub Actions",
    "Infrastructure as Code", "Secrets Management", "Automation", "DevOps", "DevSecOps", "GitOps", "Event-Driven Architecture", "Load Balancers", "Traefik", "Nginx",
    "Linux", "NixOS", "Ansible", "Debian", "Ubuntu", "Proxmox",
