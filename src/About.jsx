        ...
        <div className="view-area about-container__content">
          <div className="flex-container flex-container--about">
            ...
            <div>
              ...
              <p>Since childhood, creating and tinkering with software has been a passion of mine: one which has followed me even beyond college. This journey, through various group projects and team hackathons, has provided me with a broad range of experience across the entire stack. For example, I have grown deeply familiar with both Python and C/C++.</p>
              <p>Beyond any one technology, I can quickly learn new skills and languages, and, with my persistence and my attention to detail, can break down any complex problem into concise, idiomatic solutions.</p>
